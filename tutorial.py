...
from modules.common_setting import *
import main as gm
  
IMAGE_PATH = "./assets/images/"
SOUND_PATH = "./assets/music/"
...
class Tutorial:
	...
	def __init__(self):
		...
		self.background = pg.image.load(f"{IMAGE_PATH}background.png")
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}background.png"),(0,0))
		...
		#font variable
		self.font1 = pg.font.Font(f"{FONT_PATH}caligraphy.ttf", 50) 
		self.font2 = pg.font.Font(f"{FONT_PATH}Organo.ttf", 20) 
		self.font3 = pg.font.Font(f"{FONT_PATH}Arial.ttf", 15) 
		self.font4 = pg.font.Font(f"{FONT_PATH}Arial.ttf", 15) 	
		self.font5 = pg.font.Font(f"{FONT_PATH}Organo.ttf", 10) 
		self.map = maps[1]
	...
	def button(self, msg,x,y,w,h,ic,ac):
		...
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}conf.png"),(300,950))

		if x+w > self.mouse[0] > x and y+h > self.mouse[1] > y:
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}conf-select.png"),(300,950))
			if self.click[0] == 1:
	...
	def button2(self, msg,x,y,w,h,ic,ac):
		...
		if x+w > self.mouse2[0] > x and y+h > self.mouse2[1] > y:
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}story2-select-con.png"),(100,200))
			if self.click2[0] == 1:
	...
	def button3(self, msg,x,y,w,h,ic,ac):
		...
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}conf.png"),(x,y))
	
		
		if x+w > self.mouse3[0] > x and y+h > self.mouse3[1] > y:
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}conf-select.png"),(x,y))
			if self.click3[0] == 1:
	...
	def button4(self, msg,x,y,w,h,ic,ac):
		...
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}bigcon.png"),(x,y))
	
		
		if x+w > self.mouse4[0] > x and y+h > self.mouse4[1] > y:
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}bigcon-select.png"),(x,y))
			if self.click4[0] == 1:
	...
	def gameButton(self, msg,x,y,w,h,ic,ac):
		...
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}pred.png"),(x,y))
		#pg.draw.rect(self.screen, ac,(x,y,w,h))
		if x+w > self.mouseg[0] > x and y+h > self.mouseg[1] > y:
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}pgreen.png"),(x,y))
			if self.clickg[0] == 1:
				self.playing = False
				self.g.run()
	...
	def run(self):
		pg.mixer.music.load(f"{SOUND_PATH}song.wav")
	...
	def draw(self):
		...
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}left_margin.png"),(0,0))
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}right_margin.png"),(800,0))

		self.screen.blit(text, textRect)
		
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}2-R3.png"),(250,75))
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}1-L2.png"),(620,75))

		self.screen.blit(pg.image.load(f"{IMAGE_PATH}sushi1.png"),(325,125))
		self.screen.blit(pg.image.load(f"{IMAGE_PATH}sushi2.png"),(475,125))
	...
	def story(self): 
		if self.story_progress == True:
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}story title.png"),(0,0))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}left_margin.png"),(0,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}right_margin.png"),(800,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}story1.png"),(150,200))
	...
	def story2(self): 
		if self.story_progress2 == True:
			...
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}left_margin.png"),(0,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}right_margin.png"),(800,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}story2.png"),(100,200))
	...
	def controls(self):
		if self.story_progress4 == True:
			#clear the screen 
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}background.png"),(200,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}left_margin.png"),(0,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}right_margin.png"),(800,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}p1.png"),(0,0))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}p2.png"),(0,600))
	...
	def players(self):
		if self.story_progress3 == True:
			#clear the screen 
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}players.png"),(5,5))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}background.png"),(200,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}left_margin.png"),(0,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}right_margin.png"),(800,200))
	...
	def blockex(self):
		if self.story_progress5 == True:
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}bonus.png"),(0,0))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}background.png"),(200,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}left_margin.png"),(0,200))
			self.screen.blit(pg.image.load(f"{IMAGE_PATH}right_margin.png"),(800,200))
